/**
 * Restore Original Files - Remove all dark mode changes
 * Uploads: style.css, header.php, app.js, sidebar.php
 */
...
async function main() {
  ...
  console.log('🔄 RESTORING ORIGINAL FILES - REMOVING DARK MODE');
  console.log('='.repeat(70));
  ...
  if (successCount === filesToDeploy.length) {
    ...
    console.log('   • All dark mode styling removed');
    console.log('   • Questionnaire form restored to original');
    console.log('   • Theme toggle removed');
    console.log('   • Original light theme restored\n');
  } else {
