/**
 * Deploy Rollback - Restore files to previous version
...
async function main() {
  ...
  console.log('↩️  DEPLOYING ROLLBACK - RESTORING PREVIOUS VERSION');
  console.log('='.repeat(70));
  ...
  if (successCount === filesToDeploy.length) {
    ...
    console.log('   • Previous sidebar design restored\n');
  } else {
